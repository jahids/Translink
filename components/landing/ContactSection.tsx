...
const CONTACT_EMAIL = "jkco.contact@gmail.com";
...
function ContactUs() {
  ...
  const animateOut = () => {
    ...
    tl.to(
      [contentRef.current, imageRef.current, logoRef.current, titleRef.current, testimonialRef.current],
  ...
  const handleSubmit = (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    const subject = encodeURIComponent(`New enquiry from ${name} via TransLink website`);
    ...
    <>
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-8 xl:gap-10">
            ...
            <div ref={formRef} className="space-y-4 sm:space-y-6">
              ...
              >
                ...
                <Button
                  ...
                  className="bg-primary hover:bg-primary/90 w-full py-3 sm:py-4 font-medium text-white text-sm sm:text-base disabled:opacity-50"
          ...
          {/* Right Column — Case Studies showcase */}
          <div className="relative rounded-2xl lg:col-span-2">
            ...
            <div className="absolute bottom-0 w-full">
              <div ref={contentRef} className="relative p-4 sm:p-6 lg:p-8">
                ...
                {(t.caseStudiesData[currentIndex]?.testimonial ?? currentCaseStudy.testimonial) && (
                  <div
                    ref={testimonialRef}
                    ...
                    <div className="flex items-center justify-between gap-3 sm:gap-4">
                      <div>
                        ...
                        <p className="text-xs text-gray-300" itemProp="authorPosition">
                          {t.caseStudiesData[currentIndex]?.position ?? currentCaseStudy.position}
                        </p>
                      </div>
                      <div className="flex gap-1.5 sm:gap-2">
                        ...
                        >
                          <svg className="h-4 w-4 text-white transition-transform duration-300 group-hover:scale-110 sm:h-5 sm:w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
