      ...
      >
        ...
        >
          <Button
            ...
            asChild
          >
            <Link href="/#contact">{t.hero.talkBtn}</Link>
          </Button>
          <Button
            type="button"
            className="cursor-pointer"
            ...
            asChild
          >
            <Link href="/#case-studies-section">{t.hero.caseStudiesBtn}</Link>
          </Button>
        </div>

        <div className="relative" role="region" aria-label={t.hero.clientsLabel}>
                ...
                <div className="w-full max-w-sm space-y-3 text-left">
                  ...
                  <div className="space-y-1">
                    <p className="text-heading text-md leading-snug">
                      {t.caseStudiesData[index]?.project_title ?? caseStudy.project_title}
                    </p>
                    <div className="flex items-center gap-3">
                      <p className="text-heading text-sm font-medium">{caseStudy.name}</p>
                      <p className="text-heading text-sm">[SOFTWARE]</p>
                    </div>
                  </div>
                </div>
              </CarouselItem>
